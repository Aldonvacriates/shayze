    ...
    <footer className="bg-[#0A0A0A] border-t border-[#C9A84C]/20 py-12 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="text-[#C9A84C] hover:text-[#d4b55e] transition-colors" aria-label="X">
        ...
        <div className="border-t border-[#C9A84C]/20 pt-8 text-center">
          ...
          <p className="text-[#F5F0E8]/40 mt-3 text-sm">
            Crafted by{' '}
            <a
              href="https://github.com/Aldonvacriates"
              target="_blank"
            ...
            {' & '}
            <a
              href="https://github.com/BartuClskn"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#C9A84C]/80 hover:text-[#C9A84C] transition-colors"
            >
